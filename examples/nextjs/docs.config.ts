...
export const COMPONENT_SECTIONS: DocSection[] = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        title: "Carousel 轮播图",
        en: "Carousel",
        desc: "左侧大图 + 右侧卡片文案 + 底部缩略图切换。",
        keywords: ["轮播图", "carousel", "slider", "gallery", "缩略图", "卡片式"],
        icon: ICON_LIST,
      },
      {
        href: "/demo/input",
        ...
        api: [
          {
            ...
            props: [
              {
                name: "target",
                desc: "滚动容器，null（默认）为 window；滚动/尺寸变化自动重估，懒加载可 refresh()",
                type: "HTMLElement | null",
                default: "null",
              },
              {
                name: "size",
                desc: "本体直径 px（内部钳制最小 44 触控命中区）",
                type: "number",
                default: "48",
              },
              {
              ...
              {
                name: "content",
                desc: "中心内容自定义：HTML 字符串或节点，缺省为方向箭头",
                type: "string | HTMLElement",
                default: "箭头",
              },
              {
                name: "position",
                desc: "悬浮位置（px），如 { right: 24, bottom: 24 }；bottom 缺省自动叠加 safe-area",
                type: "ScrollFabPosition",
                default: "右下 24/24",
              },
              { name: "zIndex", desc: "z-index", type: "number", default: "9999" },
              { name: "className", desc: "附加类名", type: "string", default: "-" },
              {
                name: "animate",
                desc: "动画开关；关闭或 prefers-reduced-motion 时程序滚动瞬时到位",
                type: "boolean",
                default: "true",
              },
              {
                name: "ariaLabelToBottom / ariaLabelToTop",
                desc: "两模式无障碍标签",
                type: "string",
                default: "内置中文",
              },
              {
                name: "onModeChange",
                desc: "模式翻转回调",
                type: "(mode: 'to-bottom' | 'to-top') => void",
                default: "-",
              },
            ],
          },
          {
            ...
            props: [
              {
                name: "new ScrollFab(options?)",
                desc: "构造并 portal 到 body（fixed 悬浮）；仅当目标可滚动时渲染",
                type: "(options) => ScrollFab",
                default: "-",
              },
              { name: "fab.currentMode", desc: "当前模式", type: "ScrollFabMode", default: "-" },
              {
                name: "fab.scrollToBottom() / scrollToTop()",
                desc: "程序化滚动（走同一缓动/打断/追击管线）",
                type: "() => void",
                default: "-",
              },
              {
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        title: "Avatar 头像",
        en: "Avatar",
        desc: "点击头像进入编辑层，拖动 / 缩放 / 旋转 / 圆角实时预览，本地导出 Blob 与 dataURL。",
        keywords: ["头像", "avatar", "裁剪", "crop", "旋转", "缩放", "圆角", "Blob", "dataURL"],
        icon: ICON_USERS,
        api: [
          {
            title: "配置项",
          ...
          },
          {
            ...
            props: [
              {
                name: "onConfirm",
                desc: "确认后触发；本地 Canvas 导出，同时返回 Blob 与 dataURL",
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        title: "Confirm 确认框",
        en: "Confirm",
        desc: "缩放同源转场确认框：从触发控件中心弹性长出 / 缩回，互斥单例，异步确认 loading，三态返回值。",
        keywords: [
          "确认框",
          "confirm",
          "dialog",
