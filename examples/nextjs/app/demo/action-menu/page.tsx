...
import type { ActionMenuItem, ActionMenuOptions } from "@apricotdream/action-menu";
import { ActionMenu } from "@apricotdream/action-menu";
import "@apricotdream/action-menu/style.css";
...
export default function ActionMenuPage() {
  ...
  const snippets = {
    ...
    html: [
      ...
      '<html lang="zh-CN">',
      "<head>",
      '  <link rel="stylesheet" href="https://unpkg.com/@apricotdream/action-menu/style.css" />',
      "</head>",
      "<body>",
      '  <div id="root"></div>',
      '  <script type="module">',
      '    import { ActionMenu } from "https://unpkg.com/@apricotdream/action-menu";',
