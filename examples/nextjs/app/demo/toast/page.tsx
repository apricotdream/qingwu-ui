...
/* 与 @apricotdream/toast 组件一致的 SVG 图标（样式预览用） */
...
export default function ToastPage() {
  ...
  const snippets = (() => {
    ...
    const html = [
      '<script type="module">',
      '  import { toast } from "https://unpkg.com/@apricotdream/toast";',
      "</script>",
      '<link rel="stylesheet" href="https://unpkg.com/@apricotdream/toast/style.css" />',
      "<script>",
      '  toast.success("就绪");',
      "</script>",
    ].join("\n");
      ...
      >
        <div className="toast-demo">
          ...
          {/* ============================================================
              ...
              ============================================================ */}
          <section>
            <div className="toast-section-title">自适应文本 · @apricotdream/text-layout</div>
