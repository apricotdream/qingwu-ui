...
import { ICON_CLOCK, ICON_CALENDAR_DOT, ICON_USERS, ICON_MICROPHONE } from "@icon/icons";
...
const COMPONENTS = [
  { href: "/demo/button", title: "Button 按钮", desc: "药丸风格按钮，默认 / 主色 / 琥珀 / 图标四变体", icon: "◇", iconClass: "button", badge: "stable", badgeText: "稳定" },
  { href: "/demo/input", title: "Input 输入框", desc: "CSS 流光边框动画 + 简约经典样式", icon: "→", iconClass: "input", badge: "stable", badgeText: "稳定" },
  { href: "/demo/toast", title: "Toast 轻提示", desc: "ARIA live region 内建 · 6 种定位 · Promise 链 · 队列管理", icon: "◈", iconClass: "toast", badge: "stable", badgeText: "稳定" },
    ...
    <>
      ...
      <section className="hero">
        ...
        <p className="hero-sub">
          零依赖的<strong>纯 TypeScript</strong>组件，原生 DOM 渲染，<strong>React / Vue / 原生 HTML</strong> 均可使用。
          内置 1900-2100 年<strong>农历引擎</strong>，精准节气与节日计算。
        </p>
      ...
      <div className="features">
        {[
          { title: "零依赖", desc: "纯 TypeScript + 原生 DOM，无框架绑定，精确 tree-shaking，ESM/CJS 双格式输出。" },
          { title: "中国历法引擎", desc: "自研农历算法，覆盖 1900-2100 年。节气、干支、宜忌、休假日历开箱即用。" },
          { title: "框架无关", desc: "React、Vue、Svelte、原生 HTML —— 同一套 API，同一套样式，自由组合。" },
          { title: "无障碍优先", desc: "ARIA 语义完整、全键盘导航、prefers-reduced-motion 感知，为每一位用户设计。" },
        ].map((f, i) => (
      ...
      <div className="quickstart">
        ...
        <div className="quickstart-code">
          <code>
            ...
            <span className="hl-keyword">npm</span> install @qingwu/calendar{"\n\n"}
            <span className="hl-comment">// 在代码中使用</span>{"\n"}
            <span className="hl-keyword">import</span> {"{"} Calendar {"}"} <span className="hl-keyword">from</span>{" "}
            <span className="hl-string">&quot;@qingwu/calendar&quot;</span>;{"\n"}
            <span className="hl-keyword">import</span> <span className="hl-string">&quot;@qingwu/calendar/style.css&quot;</span>;{"\n\n"}
            <span className="hl-keyword">const</span> cal = <span className="hl-keyword">new</span> Calendar(el, {"{"}{"\n"}
