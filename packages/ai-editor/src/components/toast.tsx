...
/** 透传给内置 @qingwu-ui/toast 的展示选项；宿主自定义渲染器可自行决定是否采纳 */
...
export function toast(message: string, type: ToastType = "error", options?: ToastOptions): void {
  ...
  // 内置默认：@qingwu-ui/toast（随包内置，开箱即用）
