...
describe("QingWuEditor 组件", () => {
  ...
  it("正常渲染编辑器", () => {
    render(<QingWuEditor {...UPLOAD_LIMITS} />);

    expect(document.querySelector(".ProseMirror")).toBeInTheDocument();
  });

  it("支持传入 placeholder", () => {
    render(<QingWuEditor {...UPLOAD_LIMITS} placeholder="自定义占位文本" />);
  ...
  it("渲染初始内容", () => {
    render(<QingWuEditor {...UPLOAD_LIMITS} initialContent="<p>测试内容</p>" />);
